...
class TTS_Config:
    ...
    def __init__(self, configs: Union[dict, str] = None):
        # 设置默认配置文件路径
        configs_base_path: str = os.path.join(os.path.dirname(os.path.dirname(__file__)), "configs")
...
class TTS:
    def __init__(self, configs: Union[dict, str, TTS_Config], extend_path: str = None):
